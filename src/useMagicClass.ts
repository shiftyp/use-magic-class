...
interface Context<T> {
  Provider: (props: { value: T }) => JSX.Element;
...
export const createUseMagicClass = ({ useEffect, useLayoutEffect, useState, useContext, useMemo }: {
  useEffect: (cb: (() => (void | (() => void))), dependencies: any[] | undefined) => void,
  useLayoutEffect: (cb: (() => (void | (() => void))), dependencies: any[] | undefined) => void
  ...
  const [
    ...
    const states: [(setState: (value: any) => void) => void, string][] = [];
