      ...
      <div>
        <label>
          ...
          <input
            ...
            type="password"
            value={user.pass}
            onChange={({ target: { value } }) => (user.setPass(value))}
          />
        </label>
      </div>
...
const ErrMessage = ({ data }: { data: { errMessage: string | null | undefined } }) => {
  if (data.errMessage) {
    ...
    <form>
      <label>
        ...
        <select
          onChange={e => {
            sort.change({
              newColumn: e.target.value as Sort["column"]
            })
          }}
          value={sort.column}
        >
      ...
      <label>
        ...
        <input
          ...
          onChange={({ target }) => {
            sort.change({ newAscending: target.checked })
          }}
        />
      </label>
      <label>
